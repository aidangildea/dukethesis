...
![Scatter plot with shape distinctions](images/pointshape.png){#fig-pointshape}

For geometric objects with large fill spaces (ie. bar plot, pie chart), the use of the colorblind friendly palettes can be effective on its own. Nevertheless, adding fill textures to your visualization is an effective way to increase plot clarity. To do so, I used the [**ggpattern**](https://github.com/coolbutuseless/ggpattern) package.
...
![Line plot with line pattern and point shapes.](images/lineplot.png){#fig-lineplot}
...
**Keep It Simple**: Identify the most important features of your data and remove those that are unneccessay. Reducing the complexity of the plot will more succintly convey your data insights.
