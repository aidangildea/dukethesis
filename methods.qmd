...
# Create heatmap with ggplot2
  ...
  labs(title = "Color-Contrast Ratios Between Color Pairings", x = "Color 1", 
       y = "Color 2") +
  theme_duke() +
  scale_duke_continuous() +
...
p <- displayColors(final_vals)
p +
  geom_text(aes(label = "")) +
  annotate(
    "text", label = "Duke Navy Blue Copper Duke Royal Blue Eno Persimmon Dandelion Piedmont Cast Iron",
    x = 4,
    y = .5, size = 5
  ) +
...
# Create heatmap with ggplot2
  ...
  labs(title = "Color-Contrast Ratios Between Final Color Pairings", x = "Color 1", 
       y = "Color 2") +
  theme_duke() +
  scale_duke_continuous() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
