...
We will primarily interact with the Hex codes for these colors in this project, shown in @tbl-colors. Hex codes are a hexidecimal (base 16 numbering system) format for representing the amount of RBG in a particular shade [@rouse2021].
