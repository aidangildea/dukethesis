...
![Non-deuteronamolous perspective](images/balloons.png)![Deuteronamolous perspective](images/balloons2.png)
...
![](images/chromaticity.jpg){fig-align = "center"}
...
-   Recommend the use of Atkinson Hyperlegible font
    -   "Focuses on letterform distinction to increase character recognition"
...
-   Applies a Duke-specific continuous color scale to geometric objects (geom)
...
-   Best practice to use three to five colors from discrete scale [@wilkeb]
...
![Bar plot with fill texture](images/fillbar_2.png){#fig-fillbar}
